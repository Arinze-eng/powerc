...
//        enableEdgeToEdge(statusBarStyle = SystemBarStyle.dark(Color.TRANSPARENT))
        setContent {
            ...
            SpotuiTheme {
                ...
                // NOTE: Spotui's own GitHub update prompt is intentionally
                // disabled here — the WormGPT host app owns the single in-app
                // updater (RemoteConfig + AppUpdater), so we don't want a second,
                // conflicting "update available" dialog from the music module.
