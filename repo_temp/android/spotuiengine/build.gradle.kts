...
android {
    ...
    defaultConfig {
        ...
        // Library BuildConfig has no VERSION_NAME by default, but Spotui's
        // (now-disabled) UpdateChecker references it — provide it so the module
        // compiles. Kept in sync with the host app's marketing version.
